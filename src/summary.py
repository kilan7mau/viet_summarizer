...
class Summarizer():
    def __init__(self, w2v_path=r"D:\jetbrain\ideProject\PyProject\viet_summarizer\src\data\cc.vi.100.vec"):
    ...
    def summarize(self, paragraph, mode="clustering", keep_sentences=5):
        ...
        if mode == "clustering":
            ...
            scores = list(nx.pagerank(nx_graph, max_iter=2000, tol=1e-3).values())
